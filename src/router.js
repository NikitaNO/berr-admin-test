    ...
    const routes = [
        {
            ...
            getIndexRoute(nextState, cb) {
                require.ensure([], require => {
                    cb(null, {component: require('./routes/wireframe/wireframe')})
                })
            },
            childRoutes: [
                {
                ...
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/wireframe/wireframe'))
                  })
                }
              },{
                path: 'orders',
                ...
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/orders/orders'))
                  })
                }
              },{
                path: 'deliverables',
                ...
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/orders/deliverables'))
                  })
                }
              },{
                path: 'ordertemplates',
                ...
                getComponent(nextState, cb) {
                  require.ensure([], require => {
                    cb(null, require('./routes/orders/ordertemplates'))
                  })
                }
              },{
                    path: '*',
